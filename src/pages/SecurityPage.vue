    ...
    <article class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section id="backup-recovery" class="mb-16 scroll-mt-20">
        ...
        <ul class="space-y-3 text-text-light leading-relaxed">
          ...
          <li class="flex gap-3"><span class="text-accent-blue font-mono text-sm mt-1 min-w-24">RPO</span><span><strong>Measurement pending.</strong> Scaleway RDB continues to advertise continuous WAL archiving for its managed Postgres instances, but the CLI surface for arbitrary-timestamp PITR was restructured — we are verifying with Scaleway what the customer-visible restore granularity is today before publishing a number. Progress tracked in the runbook.</span></li>
        </ul>
