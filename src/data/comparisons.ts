    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Team tier — Supabase Team: $599/mo per org (SSO, log retention). Eurobase Team: €149/mo per project (dedicated PostgreSQL 16 on 2 vCPU / 4 GB RAM / 10 GB, online-resizable, daily backups + on-demand snapshots, SSO, RBAC, audit trail; SOC 2 Type II coming soon). Coming soon.',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Team / enterprise — Firebase: no fixed enterprise tier; you scale via GCP support contracts. Eurobase Team: €149/mo per project (dedicated PostgreSQL 16 on 2 vCPU / 4 GB RAM / 10 GB, online-resizable, daily backups + on-demand snapshots, SSO, RBAC, audit trail; SOC 2 Type II coming soon). Coming soon.',
